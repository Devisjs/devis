...
class Core {
            ...
            try {
                ...
                if (this.transport[id].state == 'connected') {
                    ...
                    this.transport[id].getCallback(this.ident, this.name, (result, id) => {
                        ...
                        if (!result) { console.log(colors.red("undefined pattern " + id + " at devis " + this.name)); res = null }
        ...
        process.nextTick(() => {
            ...
            if (this.transport[id].state == 'connected') {
                ...
                this.transport[id].getCallback(this.ident, this.name, (result) => {
                    ...
                    if (!result) { console.log(colors.red("undefined pattern")); res = null }
    ...
    act(args, callback) {
        ...
        this._find(args, (res, client) => {
            ...
            if (!res) { return callback(log.error("no_handle_found", client)); }
