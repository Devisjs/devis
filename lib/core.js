...
class Core extends EventEmitter {
    ...
    add(pattern, handle) {
        if (pattern == null) throw new Error("pattern couldn't be null");
        else if (typeof pattern != "object") throw new Error("pattern should be an object, not " + (typeof pattern));
        else if (typeof handle != "function") throw new Error("handle should be a function");
        else if (this.path.find(pattern) != null)
            throw new Error("This pattern already exists");
        else this.path.add(pattern, handle);
        return this;
    }
